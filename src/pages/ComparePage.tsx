...
export default function ComparePage() {
  ...
  const restaurantAId = searchParams.get('a') || undefined;
  const restaurantBId = searchParams.get('b') || undefined;
  ...
  return (
    <div className="min-h-screen bg-[#0A0E1A]">
      ...
      <nav className="border-b border-blue-500/10 bg-gray-900/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 text-sm text-gray-400">
            ...
            <a href="/compare" className="text-blue-400">Compare</a>
      ...
      <main className="pb-8">
        <CompareView restaurantAId={restaurantAId} restaurantBId={restaurantBId} />
      </main>
